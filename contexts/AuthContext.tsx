...
import { setAuthToken, setRefreshToken, setAuthUser, clearAuthData, getAuthUser, AuthUser } from '@/lib/auth-storage'
  ...
  const signUp = async (email: string, password: string, name?: string) => {
    try {
      const { data, error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: typeof window !== 'undefined' ? `${window.location.origin}/events` : undefined,
          data: {
            name: name || '',
            full_name: name || '',
          },
